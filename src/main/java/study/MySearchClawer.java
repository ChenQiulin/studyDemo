...
public class MySearchClawer {
    public static void printsearchKey(String u) throws Exception{
    ...
    public static void main(String[] args) throws Exception {
        String u = "http://music.163.com/weapi/search/suggest/multimatch?csrf_token=" ;
        printsearchKey(u);
    }
